...
ActiveRecord::Schema.define(version: 2021_01_25_122011) do
  ...
  create_table "article_tag_attachments", force: :cascade do |t|
    t.bigint "article_id", null: false
    t.bigint "tag_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["article_id"], name: "index_article_tag_attachments_on_article_id"
    t.index ["tag_id"], name: "index_article_tag_attachments_on_tag_id"
  end
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.string "author_agent", default: "", null: false
    t.text "content", default: "", null: false
    t.integer "status", default: 0, null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  add_foreign_key "article_tag_attachments", "articles"
  add_foreign_key "article_tag_attachments", "tags"
